...
import com.example.lab6.databinding.FragmentLimaPassBinding;
...
public class LimaPassFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // RecyclerView setup
        binding.listaMovLimaPass.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        binding.listaMovLimaPass.setAdapter(adapter);
    ...
    private void showCreateDialog() {
        View form = LayoutInflater.from(getContext()).inflate(R.layout.dialog_movement2, null);
